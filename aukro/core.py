...
def index():
    ...
    if "uid" in data:
        ...
        try:
            ...
            error = dict(reason="Не удалось найти продавца", details="Неправильная ссылка или нет связи с сервером")
        ...
        if result and result.group(1):
            ...
            error = dict(reason="Не удалось найти продавца", details="Неправильная ссылка")
            return render_template("seller.html", error=error)
    ...
    try:
        ...
        error = dict(reason="Не удалось найти информацию о продавце", details="Нет связи с сервером")
        return render_template("seller.html", error=error)
    ...
    try:
        ...
        error = dict(reason="Не удалось найти информацию о продавце", details="Нет нужной информации на странице")
        return render_template("seller.html", error=error)
